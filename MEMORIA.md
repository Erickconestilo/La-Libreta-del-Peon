...
| 2026-07-26 | Claude Code | phase-2-cleanup | Fase 2: migración 016 (unificar profiles→users), migración 017 (DROP tablas TopoTask), con re-verificación COUNT(*) y backup previo | abierto |
