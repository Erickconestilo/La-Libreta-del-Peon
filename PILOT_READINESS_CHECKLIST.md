...
- [x] La release Android v8 quedó preparada localmente con Gradle, firmada
  como `CN=TopoField Android Release` y con `versionCode=8`; todavía no está
  instalada porque `adb devices -l` no muestra el Galaxy.
